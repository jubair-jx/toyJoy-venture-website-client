...
const Register = ({ children }) => {
  ...
  return (
    <div>
      <div>
        <CommonBanner text={"Register Now..."}></CommonBanner>
        {children}
      </div>
          ...
          <div className="w-full  bg-gray-200 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0  dark:border-gray-700">
            <div className="p-6 text-gray-800 space-y-4 md:space-y-6 sm:p-8">
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full  bg-violet-500 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-md px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                >
                  Sign Up
                </button>
